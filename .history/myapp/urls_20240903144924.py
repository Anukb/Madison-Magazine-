...
urlpatterns = [
    ...
    path('google-auth-complete/', views.google_auth_complete_view, name='google_auth_complete'),
    path('facebook-auth/', views.facebook_auth_view, name='facebook_auth'),
    path('apple-auth/', views.apple_auth_view, name='apple_auth'),
    path('accounts/', include('social_django.urls', namespace='social')),  # Correctly including social_django URLs
]
